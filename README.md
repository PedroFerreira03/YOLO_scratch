...
`NOTE`: I messed up when changing the work environment, which ended up deleting the 30+ commits that I had done over the work in the project detailing the features that were being added to the project.
